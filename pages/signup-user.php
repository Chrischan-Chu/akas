<?php $appTitle = "AKAS | User Sign Up"; ?>
<!DOCTYPE html>
  ...
  <main class="auth">
    <section class="left">
      <div class="left-inner">
        ...
        <p class="mt-6 text-lg text-gray-700">User Sign Up</p>
        <form action="signup-process.php" method="POST" class="mt-8 space-y-5">
          ...
          <input type="date" name="birthdate" class="w-full rounded-2xl px-6 py-5 text-xl outline-none border border-transparent focus:border-black/10" style="background:var(--secondary)" />
          <div class="pt-4 flex items-center gap-8">
            ...
            <button type="submit" class="px-12 py-3 rounded-full text-xl font-medium shadow-sm hover:opacity-95 transition" style="background:var(--accent)">Sign up</button>
          </div>
